(function () {
  ...
  const stations = [
    {
      ...
      pages: [
        'Die DSGVO fiel nicht vom Himmel. Schon Art. 8 EMRK und die Art. 7 und 8 der EU-Grundrechtecharta schützen Privatleben, Kommunikation und personenbezogene Daten.',
    ...
    },
    {
      ...
      pages: [
        ...
        'Zu den To-dos zählen ein Verarbeitungsverzeichnis, eine Übersicht über Auftragsverarbeiter und Verträge, klare Prozesse und Datenschutzrichtlinien für Mitarbeitende.',
  ...
  const introPages = [
    ...
    { speaker: 'Erzählstimme', title: 'Die Schulung beginnt', body: 'Hilf der Maus jetzt dabei, ihr Wissen aufzubauen, Risiken zu erkennen und sich die Kontrolle über ihre Daten zurückzuholen.' }
  ];
  ...
  const outroPages = [
    ...
    { speaker: 'Erzählstimme', title: 'Kontrolle zurückgewonnen', body: 'Die Maus hat verstanden, dass Datenschutz, Datensicherheit und klare Regeln zusammengehören. Wissen schützt – im Unternehmen und im Alltag.' },
  ...
  function bindEvents() {
    el.startBtn.addEventListener('click', function () {
      ...
      playCutscene('intro', introPages, function () {
        el.hint.textContent = 'Beginne links bei Eule Erika und arbeite dich nach rechts vor.';
      });
    });
    ...
    el.world.addEventListener('click', function (event) {
      ...
      moveMouseTo(Math.max(6, Math.min(94, x)), Math.max(58, Math.min(84, y)));
    });
